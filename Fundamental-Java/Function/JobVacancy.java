...
public class JobVacancy {
    public static void main(String[] args) {
        ...
        boolean lolos = Recruitment(posisi, jk, umur, lulusan, pengalaman, penampilan);
    ...
    // Fungsi untuk menentukan keterima atau tidaknya pelamar
    private static boolean Recruitment(String posisi, String jk, int umur, String lulusan, int pengalaman, double penampilan) {
        boolean lolos = false;
